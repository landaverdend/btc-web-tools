...
const legacyTx2 =
  '';
describe('sighash', () => {
  const tx = Tx.fromHex(legacyTx2);

  test('test sighash', () => {
    const expected = 0x27e0c5994dec7824e56dec6b2fcb342eb7cdb0d0957c2fce9882f715e85d81a6n;

    const scriptPubKeyHex = '76a914a802fc56c704ce87c42d7c92eb75e7896bdc41ae88ac';
    const bytes = hexToBytes(scriptPubKeyHex);
    const stream = new ByteStream(new Uint8Array([...encodeVarInt(bytes.length), ...bytes]));

    const actual = tx.sighash(0, Script.fromStream(stream));
